...
public class Advertise1 extends JFrame 

{
    JPanel jpanel=new JPanel();
    JLabel label1,label2,lname,lphone,lsalary;
 ...
 Advertise1(int serial)
 {
   ...
   label1=new JLabel("Start Post For Zeropoint");
 ...
 btn1.addActionListener(handler);
         ...
         void addData(String name,String phone,String salary )
    {
        try {
            ...
            raf.writeBytes("Location: Zeropoint "+"\n");
