...
import static home.servant.finder.Advertise1.Color1;
...
public class Advertise2 extends JFrame 

{
 ...
 Advertise2(int serial)
 {
   ...
   label1=new JLabel("Start Post For Sadhur Mor");
 ...
 btn1.addActionListener(handler);
         ...
         void addData(String name,String phone,String salary )
    {
        try {
            ...
            raf.writeBytes("Location: Sadhur Mor "+"\n");
